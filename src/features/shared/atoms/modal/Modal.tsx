  ...
  return (
    <>
      {props.displayButton ? (
        <>
          <ButtonForm
            className={props.displayButton ? style.buttonModal : style.buttonModalHidden}
        ...
        <>
          <ButtonForm className={props.classNames?.button ?? ''} onPress={props.onOpen}>
            {props.button ?? null}
          </ButtonForm>
          <Modal
            ...
            <ModalContent>
              {() => (
                <>
                  ...
                  <ModalBody className={props.classNames?.modalBody ?? ''}>{props.description ?? null}</ModalBody>
                  <ModalFooter className={props.classNames?.modalHeader ?? ''}>{props.footer ?? null}</ModalFooter>
                </>
              )}
            </ModalContent>
          </Modal>
