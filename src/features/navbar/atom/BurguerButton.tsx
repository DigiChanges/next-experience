...
const BurguerButton = (props: Props) => {
  return (
    <svg className={`${props.isOpenBurguer && props.classStyle} ${props.classStyleResponsive}`} stroke="currentColor" fill="currentColor" onClick={props.handleNavbar} xmlns="http://www.w3.org/2000/svg"
