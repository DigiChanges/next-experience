  ...
  return (
    <div className={style.container}>
      <div className={style.containerUrl}>
        ...
        <span>›</span>
        <p className={style.urlActive}>{t('Setting')}</p>
      </div>
      <div className={style.containerSetting}>
        ...
        <div className={style.containerList}>
          <div className={style.tab}>
            ...
            <label className={style.labelCheck} htmlFor='t1'>
              <GiPadlock /> {t('s_changePassword')} <IoChevronForward className={style.arrowRight} />
            </label>
            <div className={style.divRight}>
              <input className={style.inputCheckResponsive} type='radio' name='tabs' id='t1b' />
              <label className={style.labelCheckResponsive} htmlFor='t1b'>
                <IoChevronBack /> {t('Setting')}
              </label>
          ...
          <div className={style.tab}>
            ...
            <label className={style.labelCheck} htmlFor='t2'>
              <RiUserUnfollowLine /> {t('s_deleteAccount')} <IoChevronForward className={style.arrowRight} />
            </label>
            <div className={style.divRight}>
              <input className={style.inputCheckResponsive} type='radio' name='tabs' id='t2b' />
              <label className={style.labelCheckResponsive} htmlFor='t2b'>
                <IoChevronBack /> {t('Setting')}
              </label>
          ...
          <div className={style.tab}>
            ...
            <label className={style.labelCheck} htmlFor='t3'>
              <FaRegBell /> {t('s_notificationSettings')} <IoChevronForward className={style.arrowRight} />
            </label>
            <div className={style.divRight}>
              <input className={style.inputCheckResponsive} type='radio' name='tabs' id='t3b' />
              <label className={style.labelCheckResponsive} htmlFor='t3b'>
                <IoChevronBack /> {t('Setting')}
              </label>
